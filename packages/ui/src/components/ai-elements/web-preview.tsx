...
export const WebPreview = ({
  ...
  return (
    <WebPreviewContext.Provider value={contextValue}>
      <div
        className={cn("flex size-full flex-col rounded-lg border border-border bg-card", className)}
        {...props}
      >
        {children}
      </div>
...
export const WebPreviewNavigation = ({
  ...
  <div className={cn("flex items-center gap-1 border-b border-border p-2", className)} {...props}>
    {children}
  </div>
);
