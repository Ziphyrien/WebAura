...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: "@/lib/github/cache", replacement: fromRoot("./just-github/src/cache.ts") },
      { find: "@/lib/github/github-fs", replacement: fromRoot("./just-github/src/github-fs.ts") },
      { find: "@/lib/github/refs", replacement: fromRoot("./just-github/src/refs.ts") },
      { find: "@/lib/github/types", replacement: fromRoot("./just-github/src/types.ts") },
      { find: "@/lib/github", replacement: fromRoot("./just-github/src/index.ts") },
      ...
      { find: "@/just-github", replacement: fromRoot("./just-github/src") },
    ],
  },
  test: {
    environment: "jsdom",
    globals: true,
    include: ["tests/**/*.test.ts", "tests/**/*.test.tsx", "just-github/tests/**/*.test.ts"],
